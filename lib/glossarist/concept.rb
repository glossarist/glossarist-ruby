module Glossarist
  class Concept < Lutaml::Model::Serializable
    ...
    yaml do
      ...
      map [:non_verb_rep, :nonVerbRep], to: :non_verb_rep
      map [:extension_attributes, :extensionAttributes], to: :extension_attributes
      map [:lineage_source, :lineageSource], to: :lineage_source
