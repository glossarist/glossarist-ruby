...
If not provided all the concepts will be converted to the latex format
(Optional)

|-o, --output-file
|Output file path. By default the output will be printed to the console
(Optional)
...
Validate Concept models

==== Usage:

[source,sh]
----
glossarist validate_concepts -p, --concept-path=CONCEPT_PATH
----
...
=== validate_id_linkages

Validate ID linkages in Concept YAML

==== Usage:

[source,sh]
----
glossarist validate_id_linkages -p, --concept-path=CONCEPT_PATH
----
...
Compare New Concepts (Concepts and their localized concepts
are stored in the same YAML Stream file) with Old Concepts (Concepts and their
localized concepts are stored in different YAML files)

==== Usage:

[source,sh]
----
glossarist compare_concepts -n, --new-concept-path=NEW_CONCEPT_PATH -o, --old-concept-path=OLD_CONCEPT_PATH
----
...
|===
|-n, --new-concept-path
|Path to new yaml concepts directory

|-o, --old-concept-path
|Path to old yaml concepts directory

|-r, --report-path
|Path to report file (Optional)

|-c, --[no-]color
|Colorize differences (Optional, default: false)
|===

=== validate_schemas

Validate Concept YAML against schemas

==== Usage:

[source,sh]
----
glossarist validate_schemas -p, --concept-path=CONCEPT_PATH -s, --schema-path=SCHEMA_PATH
----
...
|-s, --schema-path
|Path to concept schema directory or URL
...
Show the version of the Glossarist gem
